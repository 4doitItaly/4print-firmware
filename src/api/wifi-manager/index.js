...
(function() {
  ...
  module.exports = {
    ...
    findInterface: function(iface) {
      ...
      try {
        if (iface != null) {
          ...
          return {success: true, msg: _msg, "interface": iface};
        }
    ...
    connectToAP: function(_ap, cb) {
      ...
      try {
        if (!_ap.ssid.length) {
          return {success: false, msg: "Please provide a non-empty SSID."};
        }
